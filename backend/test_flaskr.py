...
# to test the delete function you have to change this parameter before
# runing the test
delete_id = 32
...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = 'postgresql://postgres:admin@localhost:5432/' + \
            self.database_name  # "postgres://{}/{}".format('localhost:5432', self.database_name)
    ...
    #test get categories - failure scenario
    ...
    # test get questions - failure scenario
    ...
    def test_405_create_new_question(self):
    ...
    # Test to search a question - failure scenario
    def test_422_wrong_request_search_question(self):
        self.search_term = {'searchTerm': 'Tom'}
        res = self.client().get('/questions/search', json=self.search_term)
        data = json.loads(res.data)
